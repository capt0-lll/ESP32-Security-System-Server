...
LicenseInfo::LicenseInfo() { showLicenseOnStart(); }
...
void LicenseInfo::showWarranty() {
  std::cout << "This program comes with ABSOLUTELY NO WARRANTY; for details "
               "type `show w`."
            << std::endl;
  std::cout << "This is free software; you can redistribute it and/or modify"
            << std::endl;
  std::cout
      << "it under the terms of the GNU General Public License as published by"
      << std::endl;
  std::cout << "the Free Software Foundation. See the GNU General Public "
               "License for more details."
            << std::endl;
}

void LicenseInfo::showLicenseOnStart() {
  std::cout << "ESP32 Security System Server Copyright (C) 2024 Eldar Vanin"
            << std::endl;
  std::cout << "This program comes with ABSOLUTELY NO WARRANTY; for details "
               "type `show w`."
            << std::endl;
